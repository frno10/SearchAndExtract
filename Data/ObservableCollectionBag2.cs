...
namespace Wpf.Frno.SearchAndExtract.Data
{
    ...
    public class ObservableConcurrentBag2<T> : IObservableCollection<T>
    {
        /// <summary>
        ...
        /// </summary>
        private ConcurrentBag<T> internalBag;
        ...
        /// </summary>
        public ObservableConcurrentBag2(Dispatcher dispatcher)
        {
        ...
        /// </summary>
        public ObservableConcurrentBag2(Dispatcher dispatcher, IEnumerable<T> collection)
        {
            this.dispatcher = dispatcher;
        ...
        public void Clear()
        {
            Interlocked.Exchange(ref internalBag, new ConcurrentBag<T>());
